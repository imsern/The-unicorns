...
for (i in pieces){
    document.getElementById(pieces[i]).innerHTML = images[i];
    // var navnpåbilde = 'unicorn'+newImages[i]+'.png';
    // document.getElementById(pieces[i]).innerHTML=`
    // <img src="/images/${navnpåbilde}" alt="brikke">
    // `;
}
